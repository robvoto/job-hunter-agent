...
export const JobHunterAdminSettings = (function () {
  ...
  function fillGlobalForm(settings) {
    ...
    setFieldValue('search_default_market_source_mode', searchDefaults.market_source_mode || 'jmm');
  ...
  function collectGlobalSettings(current) {
    ...
    return {
      ...
      search_settings: {
        ...currentSearch,
        market_source_mode: document.getElementById('search_default_market_source_mode')?.value || 'jmm',
