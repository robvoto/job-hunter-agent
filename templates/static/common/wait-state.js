(() => {
  ...
  function createController(mount) {
  ...
  window.JobHunterWaitUi = {
    createController,
  };

  window.JobHunterRunUi = window.JobHunterRunUi || {
    workspacePath: '/workspace',
    searchWaitCopy: 'This search can take a while because Job Hunter checks multiple sources, opens the job details that matter, and scores each match before it appears here.',
    redirectDelayMs: 600,
  };
})();
