...
export const SEEK_VERIFICATION_BROWSER_ALERT = requireLabel(SHARED_UI_LABELS, 'seek_verification_browser_alert', 'shared_ui_labels');
export const SEEK_SIGN_IN_BROWSER_ALERT = requireLabel(SHARED_UI_LABELS, 'seek_sign_in_browser_alert', 'shared_ui_labels');
export const SEEK_SIGN_IN_HEADLINE = requireLabel(SHARED_UI_LABELS, 'seek_sign_in_headline', 'shared_ui_labels');
export const SEEK_ATTENTION_TAB_TITLE = requireLabel(SHARED_UI_LABELS, 'seek_attention_tab_title', 'shared_ui_labels');
