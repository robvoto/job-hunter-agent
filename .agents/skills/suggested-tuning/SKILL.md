...
- `ONET_FAR_OCCUPATION` (title didn't match target/adjacent patterns and O*NET confirmed a far occupation family; see `.agents/skills/job-filtering/SKILL.md`)
- `CARD_SPECIALIST:*`
- `DESC_CAPABILITY_LOW:*`
- `TITLE_BAD_KEYWORD:*`
- `DESC_REQUIRED_SKILL:*`
