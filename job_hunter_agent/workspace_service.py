...
def _enrich_records_with_candidate_application_history(records: list[dict]) -> list[dict]:
    ...
    # No catch-all here on purpose. When the feature is disabled the loader
    # returns an empty history rather than raising, so the only failures that
    # could reach this point are real defects. Swallowing them produced a card
...
def render_html(
    ...
    workspace_config_labels = {
        ...
        "actionRejectedLabel": _card_label("action_rejected_label"),
        "actionRejectedTooltip": _card_label("action_rejected_tooltip"),
        "actionNoResponseLabel": _card_label("action_no_response_label"),
        "actionNoResponseTooltip": _card_label("action_no_response_tooltip"),
        "actionUndoRejectedLabel": _card_label("action_undo_rejected_label"),
        "actionUndoNoResponseLabel": _card_label("action_undo_no_response_label"),
