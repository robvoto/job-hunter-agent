...
from job_hunter_agent.paths import GOVERNMENT_CONTEXT_PATTERNS_PATH
...
def load_government_context_patterns() -> list[dict[str, Any]]:
    payload = load_managed_knowledge_payload(GOVERNMENT_CONTEXT_PATTERNS_PATH, entries_key=MANAGED_KNOWLEDGE_ENTRIES_KEY)
...
def save_government_context_patterns(entries: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return save_managed_knowledge_payload(GOVERNMENT_CONTEXT_PATTERNS_PATH, payload)
