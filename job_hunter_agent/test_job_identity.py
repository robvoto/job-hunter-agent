...
def test_normalize_job_key_seek_url():
    ...
    assert (
        normalize_job_key("https://seek.com.au/job/7945621?type=standout&tracking=abc")
        == "seek:7945621"
    )
...
def test_normalize_job_key_linkedin_url():
    ...
    assert (
        normalize_job_key("https://linkedin.com/jobs/view/39845512?refId=xyz")
        == "linkedin:39845512"
    )
...
def test_record_helper_normalization():
    ...
    record = {RECORD_JOB_KEY: "https://seek.com.au/job/12345", RECORD_SOURCE_KEY: "SEEK"}
