...
from job_hunter_agent.paths import ROLE_TITLE_RULES_PATH
...
def load_role_title_rules() -> list[dict[str, Any]]:
    payload = load_managed_knowledge_payload(ROLE_TITLE_RULES_PATH, entries_key=MANAGED_KNOWLEDGE_ENTRIES_KEY)
...
def save_role_title_rules(entries: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return save_managed_knowledge_payload(ROLE_TITLE_RULES_PATH, payload)
