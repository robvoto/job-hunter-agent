...
LLM_EVIDENCE_TIERS = (
    (KEY_PRIMARY_CANDIDATE_PROFILE_CONTEXT, "Primary candidate profile context", 1.0, 1600),
    (KEY_SECONDARY_CANDIDATE_PROFILE_CONTEXT, "Secondary candidate profile context", 0.55, 900),
    (KEY_SUPPLEMENTARY_CANDIDATE_PROFILE_CONTEXT, "Supplementary candidate profile context", 0.25, 600),
)
...
LLM_PROMPT_USE_AT_MOST_SIX = "Use at most six learning candidates."
