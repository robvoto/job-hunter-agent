...
LLM_FIT_REVIEW_PROMPT_SHAPE = (
    ...
    '"requirement_type":"capability|eligibility|qualification","canonical_requirement":"...","named_alternatives":["..."],"status":"supported|partially_supported|not_shown|mismatch",'
