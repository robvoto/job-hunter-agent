...
LLM_FIT_REVIEW_PROMPT_SHAPE = (
    ...
    '"requirement_type":"eligibility","requirement_subtype":"...","canonical_requirement":"...","named_alternatives":["..."],"profile_fact_resolved":true|false,"classification_reviewable":true|false,"status":"supported|partially_supported|not_shown|mismatch",'
    ...
    '"requirement_type":"capability|eligibility|qualification","requirement_subtype":"...","canonical_requirement":"...","named_alternatives":["..."],"profile_fact_resolved":true|false,"classification_reviewable":true|false,"status":"supported|partially_supported|not_shown|mismatch",'
    '"matched_candidate_fact":"...","matched_job_text":"...","profile_support":["..."],"covered_requirement_elements":["..."],"experience_components":[{"kind":"duration|role_or_activity|qualifier","text":"...","profile_supported":true|false,"profile_evidence":["..."]}],"role_defining":true|false,"role_defining_group":"..."}],'
    '"debug_reason":"..."}'
)
