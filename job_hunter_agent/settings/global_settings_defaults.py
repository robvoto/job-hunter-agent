...
DEFAULT_DESCRIPTION_COMPACTION_SETTINGS = dict(_MANAGED_GLOBAL_SETTINGS_SEED.get(KEY_DESCRIPTION_COMPACTION_SETTINGS, {
    KEY_COMPACTION_ENABLED: True,
    KEY_COMPACTION_MIN_CHARS: 400,
    KEY_COMPACTION_MIN_RETENTION: 0.5,
}))
DEFAULT_SOURCE_DOCUMENT_SETTINGS = {
    KEY_CV_CHARS_PER_PAGE: int(_MANAGED_GLOBAL_SETTINGS_SEED[KEY_SOURCE_DOCUMENT_SETTINGS][KEY_CV_CHARS_PER_PAGE]),
