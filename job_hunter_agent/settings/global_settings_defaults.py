...
KEY_ACCESS_SETTINGS = "access_settings"
KEY_REQUIRE_APPROVAL_FOR_NEW_USERS = "require_approval_for_new_users"
KEY_UI_SETTINGS = "ui_settings"
...
KEY_SEARCH_PLAN_MAX_AGE_MINUTES = "search_plan_max_age_minutes"
KEY_SEARCH_PLAN_MIN_CORROBORATION_SAMPLES = "search_plan_min_corroboration_samples"
KEY_LINKEDIN_FAILURE_BACKOFF_MINUTES = "linkedin_failure_backoff_minutes"
KEY_LINKEDIN_STALE_FALLBACK_MAX_AGE_MINUTES = "linkedin_stale_fallback_max_age_minutes"
KEY_LINKEDIN_MAX_CONSECUTIVE_TARGET_FAILURES = "linkedin_max_consecutive_target_failures"
KEY_INCREMENTAL_SEARCH_OVERLAP_DAYS = "incremental_search_overlap_days"
KEY_INCREMENTAL_SEARCH_CATCH_UP_INTERVAL_DAYS = "incremental_search_catch_up_interval_days"
KEY_INCREMENTAL_SEARCH_LATE_DISCOVERY_THRESHOLD_DAYS = "incremental_search_late_discovery_threshold_days"
...
KEY_LLM_REQUEST_TIMEOUT_SECONDS = "request_timeout_seconds"
KEY_LLM_MAX_RETRIES = "max_retries"
KEY_LLM_TEMPERATURE = "temperature"
...
KEY_LLM_MODEL_OVERRIDES_BY_PURPOSE = "model_overrides_by_purpose"
...
KEY_SEEK_ENABLED = "seek_enabled"
KEY_LINKEDIN_ENABLED = "linkedin_enabled"
KEY_APSJOBS_ENABLED = "apsjobs_enabled"
...
KEY_LINKEDIN_JOBSPY_STALL_TIMEOUT_SECONDS = "linkedin_jobspy_stall_timeout_seconds"
KEY_LINKEDIN_PARALLEL_SEARCH_WORKERS = "linkedin_parallel_search_workers"
...
KEY_SEEK_MANUAL_VERIFICATION_TIMEOUT_MS = "seek_manual_verification_timeout_ms"
...
KEY_POTENTIAL_RETENTION_DAYS = "potential_retention_days"
KEY_POTENTIAL_POSTED_AGE_LIMIT_DAYS = "potential_posted_age_limit_days"
KEY_POSTED_AGE_BADGE_THRESHOLD_DAYS = "posted_age_badge_threshold_days"
KEY_HIDDEN_RETENTION_DAYS = "hidden_retention_days"
KEY_APPLIED_RETENTION_DAYS = "applied_retention_days"
...
DEFAULT_ACCESS_SETTINGS = dict(_MANAGED_GLOBAL_SETTINGS_SEED.get(KEY_ACCESS_SETTINGS, {}))
DEFAULT_ACCESS_SETTINGS.setdefault(KEY_REQUIRE_APPROVAL_FOR_NEW_USERS, True)
DEFAULT_UI_SETTINGS = dict(_MANAGED_GLOBAL_SETTINGS_SEED.get(KEY_UI_SETTINGS, {}))
DEFAULT_UI_SETTINGS.setdefault(KEY_DEFAULT_THEME, "dark-professional")
DEFAULT_SEARCH_SETTINGS = dict(_MANAGED_GLOBAL_SETTINGS_SEED[KEY_SEARCH_SETTINGS])
DEFAULT_SEARCH_SETTINGS.setdefault(KEY_SEEK_ENABLED, True)
DEFAULT_SEARCH_SETTINGS.setdefault(KEY_LINKEDIN_ENABLED, True)
DEFAULT_SEARCH_SETTINGS.setdefault(KEY_APSJOBS_ENABLED, True)
...
CACHE_SETTING_LIMITS: dict[str, tuple[int, int]] = {
    ...
    KEY_SEARCH_PLAN_MAX_AGE_MINUTES: (1, 10_080),
    KEY_SEARCH_PLAN_MIN_CORROBORATION_SAMPLES: (1, 10),
    KEY_LINKEDIN_FAILURE_BACKOFF_MINUTES: (1, 1_440),
    KEY_LINKEDIN_STALE_FALLBACK_MAX_AGE_MINUTES: (1, 10_080),
    KEY_LINKEDIN_MAX_CONSECUTIVE_TARGET_FAILURES: (1, 24),
    KEY_INCREMENTAL_SEARCH_OVERLAP_DAYS: (1, 30),
    KEY_INCREMENTAL_SEARCH_CATCH_UP_INTERVAL_DAYS: (1, 365),
    KEY_INCREMENTAL_SEARCH_LATE_DISCOVERY_THRESHOLD_DAYS: (1, 30),
}
