...
_CAPABILITY_UI_LABEL_KEYS = (
    ...
    "related_skills_show_more",
    "related_skills_show_less",
...
_SHARED_UI_LABEL_KEYS = (
    ...
    "seek_verification_browser_alert",
    "seek_sign_in_browser_alert",
    "seek_attention_tab_title",
...
_SETTINGS_ALERTS_LABEL_KEYS = (
    ...
    "agent_tokens_heading",
    "agent_tokens_copy",
    "agent_tokens_generate_label",
    "agent_tokens_generating_label",
    "agent_tokens_empty",
    "agent_tokens_secret_label",
    "agent_tokens_secret_help",
    "agent_tokens_copy_label",
    "agent_tokens_copied",
    "agent_tokens_created_template",
    "agent_tokens_revoke_label",
    "agent_tokens_revoking_label",
    "agent_tokens_load_error",
    "agent_tokens_create_error",
    "agent_tokens_revoke_error",
    "agent_tokens_copy_error",
    "agent_tokens_plan_label",
    "schedule_status_off",
...
_GLOBAL_SETTINGS_LABEL_KEYS = (
    ...
    "potential_retention_days_label",
    "potential_retention_days_help",
    "hidden_retention_days_label",
    "hidden_retention_days_help",
    "applied_retention_days_label",
    "applied_retention_days_help",
