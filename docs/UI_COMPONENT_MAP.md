...
| Capability editor / capability card | `settings-matrix.html` sections; rendered by `settings-capability-editor.js`, `settings-clearance-editor.js`, `settings-page.js` (role history readonly) | `settings-page.css` (`.capability-group`, `.capability-editor`, `.capability-card`) | `settings-capability-editor.js`, `settings-clearance-editor.js`, `settings-page.js` | `capability_ui_labels`, `settings_clearances_labels`, `role_history_labels` | Capability Matrix, Clearances, Captured role history (all Settings only) | **Documented exception:** base rules live in `settings-page.css`, not `themes.widgets.css`, because every consumer is the Settings page. If a consumer outside Settings ever needs this pattern, promote the base rules to `themes.widgets.css` first. |
