...
| Standard checkbox / grouped checkbox list | Native checkbox markup excluding `role="switch"`; grouped lists use `.checkbox-list-grid`, `.checkbox-list-group`, `.checkbox-list-options`, `.checkbox-list-option` | `themes.widgets.css` | Page-specific renderer supplies data; Settings uses `settings-page.js` | Owning data/label source | Location selector and results feedback checkboxes | Page CSS may define only outer layout; checkbox appearance must remain common |
