...
def test_prompt_settings_form_uses_individual_textareas() -> None:
    ...
    assert 'id="llm_prompt_fit_review_debug_match_diagnostics_enabled"' in html
    ...
    assert "Fit review debug match diagnostics" in html
...
def test_prompt_settings_script_maps_individual_fields() -> None:
    ...
    assert "fit_review_debug_match_diagnostics_enabled" in js
    assert "llm_prompt_fit_review_debug_match_diagnostics_enabled" in js
