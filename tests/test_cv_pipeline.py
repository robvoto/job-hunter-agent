...
from job_hunter_agent.cv_pipeline import _tool_terms, run_cv_pipeline, score_and_promote
...
def test_run_cv_pipeline_works_from_raw_cv_text_without_role_parser():
    text = """
# Professional Experience
Scrum Master
Company Name | 2022 - Present
- Facilitated Agile ceremonies and delivery coordination.
- Improved sprint planning and stakeholder communication.
"""

    output = run_cv_pipeline(text)

    assert output["dominant_signal_clusters"]
    assert "role_experience" not in output
