...
sudo sed -i '1s/^\xEF\xBB\xBF//' /usr/local/bin/deploy-jobhunter /usr/local/bin/jobhunter-status /usr/local/bin/jobhunter-logs /usr/local/bin/sync-knowledge
...
echo "Helpers installed: deploy-jobhunter, jobhunter-status, jobhunter-logs, sync-knowledge, use-ubuntu"
