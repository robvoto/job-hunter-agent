...
4. Load only the relevant `.skills/*/SKILL.md` files required for the task.
...
Do not edit `AGENTS.md`, `.clinerules/`, `docs/CLINE_MEMORY.md`, `docs/AGENT_OPERATING_MODEL.md`, `docs/DOC_INDEX.md`, or `.skills/` unless the human explicitly requested instruction maintenance. Product work must not rewrite Cline's own instructions.
